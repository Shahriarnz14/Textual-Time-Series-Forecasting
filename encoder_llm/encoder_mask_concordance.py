...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data_directory', type=str, default='small_ordered_l33train', help='Directory containing training data')
    parser.add_argument('--test_data_directory',  type=str, default='small_ordered_l33test', help='Directory containing test data')
    ...
    parser.add_argument('--do_zero_shot', action='store_true', default=True, help='Enable zero-shot evaluation')
    ...
    model = MaskedEventClassifier(args.model_name, tokenizer).to(device)
    ...
    if not args.do_zero_shot:
        ...
        best_f1, best_threshold = train_mask_concordance_model(
