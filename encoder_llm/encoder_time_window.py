...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_results_text_file', type=str, default='test_f1_scores.txt', help='File to save test results')
    ...
    _, time_classification_data = prepare_dataset(train_timeseries_data, K, H)
    ...
    time_classification_data_train = preprocess_and_tokenize_data(time_classification_data_train, tokenizer, args.max_length, args.batch_size)
    time_classification_data_val = preprocess_and_tokenize_data(time_classification_data_val, tokenizer, args.max_length, args.batch_size)
