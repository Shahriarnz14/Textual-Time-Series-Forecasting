...
def parse_args():
    ...
    parser.add_argument('--data_folder', type=str, default="phe_deceased/sepsis10")  # e.g., phe_deceased/sepsis10
    ...
    if args.output_pickle is None:
        args.output_pickle = f"{args.data_folder}/survival_data_embeddings_{args.model_name.split('/')[-1]}_t{args.time_of_interest}.pkl"
...
def main():
    args = parse_args()
    tts_folder_path = os.path.join(args.data_folder, 'DS_timeord_tts')
    event_time_folder_path = os.path.join(args.data_folder, 'clean_bsv')
